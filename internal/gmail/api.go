...
//
// This is the read-only edition of msgvault: there is no write surface
// here (no Trash, no Delete, no Modify, no Send). The interface is
// exactly AccountReader + MessageReader + Close.
type API interface {
	AccountReader
	MessageReader
